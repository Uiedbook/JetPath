...
import { _JetPath_app_config, _JetPath_hooks, _JetPath_paths, compileAPI, compileUI, getHandlers, UTILS, } from "./primitives/functions.js";
    ...
    <!-- <script type="module" src="index.js"  >
       ...
       <a style="text-align: center; margin-top: 5rem;">2024 Alrights reserved {NAME}</a>
        ...
        if (typeof this.options !== "object" ||
            ...
            console.log(`\n Parsed ${handlersCount} handlers in ${Math.round(endTime - startTime)} milliseconds`);
        }
        else {
            // ? Load all jetpath functions described in user code
